...
const Home = () => {
  ...
  useEffect(() => {
    fetch("http://localhost/Ass/kimdong_bookstore/api/home/listAuthor")
  ...
  useEffect(() => {
    fetch("http://localhost/Ass/kimdong_bookstore/api/home/listPost")
      .then((response) => response.json())
      .then((data) => {
        if (data.success) {
  ...
  useEffect(() => {
    fetch("http://localhost/Ass/kimdong_bookstore/api/home/listBook")
      .then((response) => response.json())
      .then((data) => {
        if (data.success) {
        ...
        <div className="news-wrapper" ref={containerRefN}>
          {newsData.map((news) => (
            <div className="news-card" key={news.id}>
              <div className="baner-img-container"><img src={`http://localhost/Ass/kimdong_bookstore/${news.img}`} alt={news.title} /></div>
      ...
      <div className="posts">
          {newsData.map((post) => (
            <div className="post-card" key = {post.id}>
              <div className="post-img-container"><img src={`http://localhost/Ass/kimdong_bookstore/${post.img}`} alt={post.title} /></div>
            ...
            {listWriters.map((writer) => (
              <div className="card" key={writer.id}>
                <div className="writer-img-container">
                  <img src={`http://localhost/Ass/kimdong_bookstore/${writer.img}`} alt={writer.name}></img>
                </div>
          ...
          <div className="container" ref={containerRefB}>
            {incgBooks.map((book) => (
              <div className="card" key ={book.id}>
                <div className="writer-img-container">
                  <img src={`http://localhost/Ass/kimdong_bookstore/${book.img}`} alt={"img"}></img>
                </div>
