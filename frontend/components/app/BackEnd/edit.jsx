...
export default function Edit() {
    ...
    useEffect(() => {
        fetch(`https://localhost/BTL_web_1/frontend/components/app/BackEnd/php/uploads/Data.php?&url=${encodeURIComponent("tat_ca_san_pham")}&variable=${encodeURIComponent(value)}`)
