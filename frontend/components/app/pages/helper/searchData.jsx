...
export function useData(img = [], url, search) {  
  ...
  useEffect(() => {
      const fetchData = async () => {
          try {
              const response = await fetch(`http://localhost/kimdong_bookstore/frontend/components/app/BackEnd/php/uploads/getSearch.php?&url=${encodeURIComponent(url)}&variable=${encodeURIComponent(search)}`);
              if (!response.ok) {
