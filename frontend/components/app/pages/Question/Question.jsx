        ...
        <div>
            <div class="bg-amber-50  flex flex-col w-full items-center lg:pb-14 md:pb-8 pb-4">
                ...
                <div class="flex items-center w-[60%] relative mb-8 lg:mb-4">
                    ...
                    <button class="cursor-pointer absolute inset-y-0 right-0 lg:w-16 md:w-12 w-10 !bg-amber-900 text-white !rounded-r-full flex items-center justify-center">
            ...
            <div className="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-6 lg:my-15 md:my-10 my-5 lg:p-5 p-3">
                    ...
                    <div className="lg:p-4">
                        {faqs.map((faq, index) => (
                            <div key={index} className="border border-gray-300 rounded-lg p-4 lg:mb-4 mb-2">
                                <a href="/faq/question/comment" class="text-blue-600">
                ...
                <div className="col-span-1 lg:p-3 p-1 bg-white">
                    ...
                    />
                    <button className="lg:mt-3 w-full lg:p-3 lg:text-xl p-1 h-xl lg:h-auto mt-8  text-gray-700 hover:!bg-gray-100 hover:border-1 hover:border-gray-800 rounded-lg cursor-pointer">
                        Gửi câu hỏi
                    </button>
                </div>
            </div>
