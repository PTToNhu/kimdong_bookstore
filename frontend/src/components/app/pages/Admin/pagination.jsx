...
const PaginationHelper = ({ data = [], checkedItems, handleCheckboxChange, formatPrice, handleStatusChange, toggleModal, open, edit, setID, results, handleCheckAll, allChecked }) => {
    ...
    function getData() {
        ...
        temp.map((element, index) => {
            if(element){
                result.push(
                <tr className={`${index % 2 === 0 ? "bg-gray-100" : ""} text-2xl`} key={element.id}>
                    ...
                    <td className="px-2  min-w-[900px] max-w-[900px] overflow-hidden whitespace-nowrap">{element.name}</td>
            ...
            <table className="min-w-full border-collapse">
                <thead>
                    <tr className="bg-gray-200">
                        ...
                        <th className="py-2 max-w-[900px] overflow-hidden">Name</th>
