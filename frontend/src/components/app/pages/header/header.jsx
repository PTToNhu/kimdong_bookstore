        ...
        >
          <div className="flex items-center text-[20px] h-full relative w-[1400px] justify-center">
            ...
            <ul className="text-white flex text-[20px] max-lg:hidden">
              ...
              <li className="px-[10px] hover:text-[#15A78A] cursor-pointer">
                <a href="/about_us" className="no-underline! text-white">
                  TRANG GIỚI THIỆU <FontAwesomeIcon icon={faChevronDown} />
                </a>
              </li><li className="px-[10px] hover:text-[#15A78A] cursor-pointer">
                <a href="/faq" className="no-underline! text-white">
                  TRANG HỎI ĐÁP <FontAwesomeIcon icon={faChevronDown} />
                </a>
              </li>
              <li className="px-[10px] hover:text-[#15A78A] cursor-pointer">
                <a href="/news" className ="no-underline! text-white">
